...
import test.cldc.sub.AttributeTester;
...
public class CLDCTestSuite extends AbstractTestSuite {
	...
	public void testForName() {
		...
		try {
			c = Class.forName("test.cldc.TestClass");
	...
	public void testGetName() {
		...
		check(TestClass.class.getName(), "test.cldc.TestClass");
	}
...
//		
//		// Test 1
//		InputStream is = CLDCTestSuite.class.getResourceAsStream("/test/cldc/file.txt");
//
//		int val = -1;
//		try {
//			val = is.read();
...
//	}
	...
	public void testStack() {
		checkPoint("java.util.Stack");
		new StackTest().test(this);
	}
