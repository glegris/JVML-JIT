...
//		harness.check(!(!Float.toString(0.001f).equals("0.001")), "Float.toString: - 10");
	...
	public void test_floatToIntBits() {
		harness.check(!(Float.floatToIntBits(Float.POSITIVE_INFINITY) != 0x7f800000), "Float.floatToIntBits: - 1");
		harness.check(!(Float.floatToIntBits(Float.NEGATIVE_INFINITY) != 0xff800000), "Float.floatToIntBits: - 2");

		int nanval = Float.floatToIntBits(Float.NaN);
		harness.check(!(nanval != 0x7fc00000), "Float.floatToIntBits: - 3");
		...
		harness.check(!(sign1 != 0), "Float.floatToIntBits: - 4");

		harness.check(!(sign2 != 0x80000000), "Float.floatToIntBits: - 5");

		harness.check(!(exp1 != 1971322880), "Float.floatToIntBits: - 6");

		harness.check(!(exp2 != 1107296256), "Float.floatToIntBits: - 7");

		harness.check(!(man1 != 400186), "Float.floatToIntBits: - 8");

		harness.check(!(man2 != 671089), "Float.floatToIntBits: - 9");
	...
	/**
	 * Some checks for values that should parse to Float.POSITIVE_INFINITY
